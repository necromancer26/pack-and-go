...
import models.*;
import services.PersonalityComponentsController;
...
public class DashboardController implements Initializable {
    ...
    public void initSocialStyles() {
        ...
        socialIdColumn.setVisible(false);
    ...
    public void initInteractionStyles() {
        ...
        interactionIdColumn.setVisible(false);
    ...
    public void initProcessingStyles() {
        ...
        processingIdColumn.setVisible(false);
    ...
    public void initDecisionMakingStyles() {
        ...
        decisionMakingIdColumn.setVisible(false);
    ...
    public void initUserPersonalityTable() {
        ...
        userPersonalityIdColumn.setVisible(false);
        ...
        TableColumn<UserPersonality, String> personalityColumn = new TableColumn<>("Personality Type");
...
//root.setCenter(table);
    ...
    public void initPersonalityTable() {
        ...
        TableColumn<Personality, String> personalityIdColumn = new TableColumn<>("Personality Type");
...
/*        if (!UserSession.getInstace().getRole().equals("ADMIN")) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../gui/MenuTest.fxml"));
    ...
    public void handleComboBoxPersonality(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (comboBoxSortPersonality.getValue().equals("Sort normal by ID")) {
                l = personalities.stream().sorted((o1, o2) -> o1.getPersonalityId().compareTo(o2.getPersonalityId())).collect(Collectors.toList());
