...
public class FrontRestauController implements Initializable {
    ...
    @FXML
    private void volFront(ActionEvent event) {
         FXMLLoader LOADER = new FXMLLoader(getClass().getResource("volclient.fxml"));
            try {
                Parent root = LOADER.load();
                Scene sc = new Scene(root);
                 volclient cntr = LOADER.getController();
                Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
                window.setScene(sc);
                window.show();
            } catch (Exception ex) {
    ...
    @FXML
    private void packFront(MouseEvent event) {
         FXMLLoader LOADER = new FXMLLoader(getClass().getResource("MenuTest.fxml"));
            try {
                Parent root = LOADER.load();
                Scene sc = new Scene(root);
                 MenuTestController cntr = LOADER.getController();
                Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
                window.setScene(sc);
                window.show();
            } catch (Exception ex) {
    ...
    @FXML
    private void activFront(MouseEvent event) {
