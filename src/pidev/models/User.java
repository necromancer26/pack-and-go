...
public class User {
    ...
    public User(int id_user, String first_name, String last_name, String email, String username, String password, int number, Roles role, LocalDateTime birthday) {
