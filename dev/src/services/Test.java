...
public class Test {
    ...
    static String[] extroversionVsIntroversionTest = {
    ...
    static int[] extrovertVsIntrovertAnswersStorage = new int[5];// answer storing
    static int[] sensingVsIntuitionsAnswersStorage = new int[5];// answer storing
    static int[] thinkingVsFeelingAnswersStorage = new int[5];// answer storing
    static int[] judgingVsPerceivingAnswersStorage = new int[5];// answer storing
    static StringBuilder result = new StringBuilder();

    public static void test() {

        // serves questions, collects strings saves answer into second array as int
        // letter option A is represented as digit 1 while option B is represented as
        // digit 0.
        ...
        System.out.printf("|%5s | %3d | %3d | %3s | %3d | %3d | %3s | %3d | %3d | %3s | %3d | %3d |%n", "TOTAL",
                countNumbers(extrovertVsIntrovertAnswersStorage, 1),
                countNumbers(extrovertVsIntrovertAnswersStorage, 0),
                " ", countNumbers(sensingVsIntuitionsAnswersStorage, 1),
                countNumbers(sensingVsIntuitionsAnswersStorage, 0), " ",
